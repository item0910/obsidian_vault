...
![[附件/image/02_Docker-1676915051661.jpeg]]
...
![[附件/image/02_Docker-1676915008940.jpeg]]
...
![[附件/image/02_Docker-1676915034003.jpeg]]
...
（3）打开浏览器 输入地址 [http://192.168.184.141:5000/v2/_catalog](http://192.168.184.141:5000/v2/_catalog) 看到 `{"repositories":[]}` 表示私有仓库搭建成功并且内容为空
